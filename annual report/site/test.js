document.addEventListener("DOMContentLoaded", (event) => {
  ...
  const nodesData = [
    //world 1
    {
      title: "AFH & Mass General Cancer Center Collaborate for Public Good",
      link: "https://www.afhannualreport.org/1-mass-general-cancer",
    },
    {
      title: "The Voices on the Public Stage",
      link: "https://www.afhannualreport.org/1-herstory",
    },
    {
      title: "When a Client Goes Deep!",
      link: "https://www.afhannualreport.org/1-quin-house",
    },
    {
      title: "Open Studio",
      link: "https://www.afhannualreport.org/2-open-studio",
    },
    //world 2
  ...
  nodesData.forEach((item) => {
    ...
    img.className = "dot";
    img.src =
      "https://static1.squarespace.com/static/646e314847f2317236a9823a/t/65787b944d4d61284df0dbde/1702394772348/Touchpoint.png";
